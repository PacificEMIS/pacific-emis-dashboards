...
def teachers_cpd_overview_layout():
    return dbc.Container([
        ...
        dbc.Row([
            dbc.Col(dcc.Graph(id="cpd-district-gender-bar-chart"), md=3, xs=12, className="p-3"),
            dbc.Col(dcc.Graph(id="cpd-school-map-chart"), md=3, xs=12, className="p-3"),
            dbc.Col(dcc.Graph(id="cpd-district-gender-trend-chart"), md=6, xs=12, className="p-3"),
        ], className="m-1"),        
        dbc.Row([
