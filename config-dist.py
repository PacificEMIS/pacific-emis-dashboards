...
TEACHERCOUNT_URL = f"{BASE_URL}/api/warehouse/teachercount/schooldimension?report"
TEACHEREDLEVEL_URL = f"{BASE_URL}/api/warehouse/teacheredlevel/schooldimension?report"
TEACHERPD_URL = f"{BASE_URL}/api/warehouse/teacherpd/schooldimension"
TEACHERPDATTENDANCE_URL = f"{BASE_URL}/api/warehouse/teacherpdattendance/schooldimension"
...
TEACHERCOUNT_URL_CACHE_FILE = f"data\\{CONTEXT}-cached_teachercountdimension_data.json"
TEACHEREDLEVEL_URL_CACHE_FILE = f"data\\{CONTEXT}-cached_teacheredleveldimension_data.json"
TEACHERPD_URL_CACHE_FILE = f"data\\{CONTEXT}-cached_teacherpdschooldimension_data.json"
TEACHERPDATTENDANCE_URL_CACHE_FILE = (
    f"data\\{CONTEXT}-cached_teacherpdattendanceschooldimension_data.json"
)
